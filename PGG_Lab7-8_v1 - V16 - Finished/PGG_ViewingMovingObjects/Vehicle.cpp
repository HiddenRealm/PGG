...
//Get Bullet Model Matrix & the Bullets Particles Model Matrix's
...
void Vehicle::Movement(SDL_Event evt, float deltaTs)
{
	...
	//checks if you collide with the wall & updates your movement in general
...
//This is where it actually checks if you go past the wall
...
//The Player and Fruit Collison
//get the min and max of each of the objects cube
//Check those are never inside of each other
bool Vehicle::FCol()
{
	if (fruits == 0)
	{
...
//Counts how many fruit collected
...
//Counts how many rocks collectec
